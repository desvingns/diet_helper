...
Without it, your custom `DietHelperApplication.onCreate()` runs `DatabaseSeeder` (or analogous code) on background coroutines,
...
class AppNavHostTest {
    ...
    @Before fun setUp() {
        composeTestRule.setContent {
            ...
            DietHelperTheme { AppNavHost(navController = navController) }
        }
    }
