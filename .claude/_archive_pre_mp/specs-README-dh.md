# [ARCHIVED 2026-07-06] `.claude/specs/` — Persistent Brainstorm Artifacts (/dh era)

> Superseded by the /mp SPEC board (`.claude/specs/{backlog,active,done}`).
> Kept verbatim below for history; the /dh pipeline itself is archived in this folder.
